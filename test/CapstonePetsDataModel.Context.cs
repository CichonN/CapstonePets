...
namespace test
{
    ...
    public partial class Entities1 : DbContext
    {
        ...
        public virtual DbSet<TMedicationOrder> TMedicationOrders { get; set; }
        ...
        public virtual DbSet<TVisitNote> TVisitNotes { get; set; }
        ...
        public virtual ObjectResult<Nullable<int>> uspGetOwnerIDFromUser(Nullable<int> intUserID)
        {
            var intUserIDParameter = intUserID.HasValue ?
                new ObjectParameter("intUserID", intUserID) :
                new ObjectParameter("intUserID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("uspGetOwnerIDFromUser", intUserIDParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> Validate_User(string strUserName, string strPassword)
        {
        ...
        public virtual int uspAddMedicationOrder(Nullable<System.DateTime> dtmOrderDate, Nullable<int> intMedicationID, string strMedicationName, Nullable<decimal> dblUnitCost, Nullable<int> intOrderQuantity, Nullable<decimal> dblTotal, string strNotes)
        {
            var dtmOrderDateParameter = dtmOrderDate.HasValue ?
                new ObjectParameter("dtmOrderDate", dtmOrderDate) :
                new ObjectParameter("dtmOrderDate", typeof(System.DateTime));
            ...
            var dblUnitCostParameter = dblUnitCost.HasValue ?
                new ObjectParameter("dblUnitCost", dblUnitCost) :
                new ObjectParameter("dblUnitCost", typeof(decimal));
    
            var intOrderQuantityParameter = intOrderQuantity.HasValue ?
                new ObjectParameter("intOrderQuantity", intOrderQuantity) :
                new ObjectParameter("intOrderQuantity", typeof(int));
    
            var dblTotalParameter = dblTotal.HasValue ?
                new ObjectParameter("dblTotal", dblTotal) :
                new ObjectParameter("dblTotal", typeof(decimal));
    
            var strNotesParameter = strNotes != null ?
                new ObjectParameter("strNotes", strNotes) :
                new ObjectParameter("strNotes", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("uspAddMedicationOrder", dtmOrderDateParameter, intMedicationIDParameter, strMedicationNameParameter, dblUnitCostParameter, intOrderQuantityParameter, dblTotalParameter, strNotesParameter);
        }
        ...
        public virtual int uspUpdateMedicationOrder(Nullable<int> intMedicationOrderID, Nullable<System.DateTime> dtmOrderDate, Nullable<int> intMedicationID, string strMedicationName, Nullable<decimal> dblUnitCost, Nullable<int> intOrderQuantity, Nullable<decimal> dblTotal, string strNotes)
        {
            var intMedicationOrderIDParameter = intMedicationOrderID.HasValue ?
                new ObjectParameter("intMedicationOrderID", intMedicationOrderID) :
                new ObjectParameter("intMedicationOrderID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("uspUpdateMedicationOrder", intMedicationOrderIDParameter, dtmOrderDateParameter, intMedicationIDParameter, strMedicationNameParameter, dblUnitCostParameter, intOrderQuantityParameter, dblTotalParameter, strNotesParameter);
        }
        ...
        public virtual int uspUpdateVisit(Nullable<int> intVisitID, Nullable<System.DateTime> dtmDateOfVist, string strVisitNotes)
        {
            var intVisitIDParameter = intVisitID.HasValue ?
                new ObjectParameter("intVisitID", intVisitID) :
                new ObjectParameter("intVisitID", typeof(int));
            ...
            var strVisitNotesParameter = strVisitNotes != null ?
                new ObjectParameter("strVisitNotes", strVisitNotes) :
                new ObjectParameter("strVisitNotes", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("uspUpdateVisit", intVisitIDParameter, dtmDateOfVistParameter, strVisitNotesParameter);
        }
    
        public virtual int uspUpdateVisitMedication(Nullable<int> intVisitMedicationID, Nullable<int> intQuantity, string strMedicationNotes)
        {
            ...
            var strMedicationNotesParameter = strMedicationNotes != null ?
                new ObjectParameter("strMedicationNotes", strMedicationNotes) :
                new ObjectParameter("strMedicationNotes", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("uspUpdateVisitMedication", intVisitMedicationIDParameter, intQuantityParameter, strMedicationNotesParameter);
        }
        ...
        public virtual ObjectResult<uspViewEmployees_Result1> uspViewEmployees()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspViewEmployees_Result1>("uspViewEmployees");
        }
    
        public virtual ObjectResult<uspViewMedications_Result1> uspViewMedications()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspViewMedications_Result1>("uspViewMedications");
        }
    
        public virtual ObjectResult<uspViewOwnerPets_Result1> uspViewOwnerPets(Nullable<long> ownerid)
        {
            var owneridParameter = ownerid.HasValue ?
                new ObjectParameter("ownerid", ownerid) :
                new ObjectParameter("ownerid", typeof(long));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspViewOwnerPets_Result1>("uspViewOwnerPets", owneridParameter);
        }
    
        public virtual ObjectResult<uspViewOwners_Result1> uspViewOwners()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspViewOwners_Result1>("uspViewOwners");
        }
    
        public virtual ObjectResult<uspViewPetGeneralInformation_Result1> uspViewPetGeneralInformation()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspViewPetGeneralInformation_Result1>("uspViewPetGeneralInformation");
        }
    
        public virtual ObjectResult<uspViewPetMedications_Result1> uspViewPetMedications()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspViewPetMedications_Result1>("uspViewPetMedications");
        }
    
        public virtual ObjectResult<uspViewPets_Result1> uspViewPets()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspViewPets_Result1>("uspViewPets");
        }
    
        public virtual ObjectResult<uspViewPetVaccinations_Result1> uspViewPetVaccinations()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspViewPetVaccinations_Result1>("uspViewPetVaccinations");
        }
    
        public virtual ObjectResult<uspViewPetVisits_Result1> uspViewPetVisits()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspViewPetVisits_Result1>("uspViewPetVisits");
        }
    
        public virtual ObjectResult<uspViewServices_Result1> uspViewServices()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspViewServices_Result1>("uspViewServices");
        }
    
        public virtual ObjectResult<Nullable<int>> Validate_User1(string strUserName, string strPassword)
        {
            var strUserNameParameter = strUserName != null ?
                new ObjectParameter("strUserName", strUserName) :
                new ObjectParameter("strUserName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("Validate_User1", strUserNameParameter, strPasswordParameter);
        }
    }
}
